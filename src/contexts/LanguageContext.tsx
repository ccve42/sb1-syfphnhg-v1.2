...
const jaTranslations: Record<string, string> = {
  ...
  'product.features.ja': '主な機能',
  'product.benefits': 'Benefits',
  'product.benefits.ja': 'メリット',
  'product.details': 'Product Details',
  'product.details.ja': '製品詳細',

  // Icon Horado
  'horado.title': 'Icon Horado',
  'horado.subtitle': 'Work-Rest Hours',
  'horado.subtitle.ja': '労働時間管理',
  ...
  'horado.description.ja': '船舶での労働時間管理は、船舶、貨物、乗組員の安全に直接影響を与えるため、非常に重要です。疲労による事故を防ぐため、国際海事機関と国際労働機関は、乗組員の労働時間と休息時間に関する厳格な規制を定めています。当社の製品は、これらの規制への準拠をサポートします。',
  ...
  'horado.details.ja': '船舶労働時間管理システムは、実施された作業時間と休息時間を記録する費用対効果の高いツールです。休息時間を計算し、国際法および国内法への準拠を自動的にチェックします。',

  // Icon Argus
  'argus.title': 'Icon Argus',
  'argus.subtitle': 'Surveys & Inspections',
  'argus.subtitle.ja': '検査・点検',
  ...
  'argus.description.ja': '船舶での各種検査・点検要件に応じてデータを収集・整理するための専用モバイルアプリケーションです。船舶管理者による検査、喫水検査、IHM検査、SIRE、Right Ship等、各種検査のチェックリストに基づいて設定可能です。',

  // Icon Maris
  'maris.title': 'Icon Maris',
  'maris.subtitle': 'Ship Guard',
  'maris.subtitle.ja': '船舶警備',
  ...
  'maris.description.ja': '休船中の船舶は、訓練を受けた警備員が24時間体制で監視しています。メンテナンスチームが定期的に船舶に乗り込み、船内の状態を確認し、必要に応じて軽微なメンテナンスを実施します。警備員は無線で基地局と連絡を取り、状況を報告します。',

  // Icon Doris
  'doris.title': 'Icon Doris',
  'doris.subtitle': 'Ship Spares Logistics',
  'doris.subtitle.ja': '船舶部品物流',
  ...
  'doris.description.ja': '船舶部品物流は、注文された部品を確実に船舶に届け、船舶の運航を維持するための重要なサービスです。当社のソリューションは、代理店、フォワーダー、船主、管理会社が世界規模で部品物流を「ドア・トゥ・デッキ」で管理することを可能にします。'
};